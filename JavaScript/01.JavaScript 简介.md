...
```javascript
document.body.style.backgroundColor = '#eee';  // 设置页面背景颜色
```
* [Web Storage API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API)
```javascript
localStorage.setItem('background', '#eee');  // 在本地存储背景颜色
```
...
## ECMAScript
ECMAScript 是 JavaScript 的语言规范，它规定了 JavaScript 语言的行为和支持特性，各个浏览器厂商根据这份规范文档实现自己的 JavaScript 引擎。
